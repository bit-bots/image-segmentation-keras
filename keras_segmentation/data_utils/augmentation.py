...
def _load_augmentation_aug_non_geometric():
    return iaa.Sequential([
        ...
        iaa.Sometimes(0.34, iaa.MultiplyHueAndSaturation((0.5, 1.5),
                                                         per_channel=True)),
        iaa.Sometimes(0.64, iaa.Grayscale(alpha=(0.0, 1.0))),
        iaa.Sometimes(0.6, iaa.ChangeColorTemperature((1100, 10000))),
...
def augment_seg(img, seg, augmentation_name="aug_all2"):
